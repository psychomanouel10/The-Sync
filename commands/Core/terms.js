...
class Terms extends Command {
  constructor(client) {
    super(client, {
      name: "terms",
      description: "Read sync's Terms of Service.",
      category: "Core",
      usage: "terms"
    });
  } 
  ...
  async run(message) { 
    ...
    const embed = new MessageEmbed()
      .setColor("RANDOM")
      .setTitle("__**sync - Terms of Service**__")
      .setDescription('\nsync has access to the End User Data through the Discord API, but sync does not collect, use and/or disclose End User Data except (a) as necessary to exercise your rights under this Agreement, (b) in accordance with Discord’s Privacy Policy.' +
