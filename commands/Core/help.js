    ...
    if (!args[0]) {
      try {
        const embed = new MessageEmbed()
          ...
          .setDescription("I'm a bot developed and maintained by manouelツ#1398\n\All my commands start with the prefix / To see all my commands use /commands!\n\ and make sure to do s.help to access to the music commands check out at youtube sync:https://bit.ly/3b1zaDr")
