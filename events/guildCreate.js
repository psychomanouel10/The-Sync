...
module.exports = class {
  ...
  async run(guild) {
    ...
    const embed = new MessageEmbed()
      .setTitle('Hiya! I\'m sync. I\'m a bot developed and maintained by manouelツ#1398.')
      .setColor('RANDOM')
      .setDescription(`You must be the server owner, ${guildOwner}! Somebody invited me to your server **${guild.name}**. My prefix is / (but can be changed).\nTo view all commands and information, use the /help and /commands /commands!`)
